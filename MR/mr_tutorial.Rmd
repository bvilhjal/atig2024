...
##### Q1: Read through the above code. How do we simulate the SNP effect sizes for the exposure and the outcome? 
...
##### Q2: Reformat your simulated data into one dataframe containing the above-mentioned columns.
...
##### Q3: How would changing `rho` affect the correlation structure, and how might this influence our MR analysis?
...
##### Q4: Use the `std_effect()` function to standardize `bzx` and `bzx_se`. Save the two new columns in `gsmr_data` as `std_bzx` and `std_bzx_se` respectively.
...
##### Q5: Run GSMR using the `gsmr()` function.
...
##### Q6: What is the result of the analysis? What does it signify?
...
##### Q7: Rerun the GSMR analysis with `heidi_outlier_flag = T` and a p-value threshold for the multi-SNP-based global HEIDI-outlier flag of 0.01.
...
##### Q8: How does the estimated effect of the exposure on the outcome change after applying HEIDI-outlier filtering compared to before?

##### Q9: How does HEIDI-outlier filtering detect potential pleiotropic SNPs? See the [**paper**](https://www.nature.com/articles/ng.3538)
...
##### Q10: Inspect the results. What is the intercept? 
