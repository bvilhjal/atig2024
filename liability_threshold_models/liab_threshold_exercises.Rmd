...
```
##### Q11: How does the estimated hazard ratio from the Cox model help us understand the effect of genetics on the time to disease onset?
...
##### Q12: How does the survival curve differ between cases and controls? What does this tell you about disease risk over time?
