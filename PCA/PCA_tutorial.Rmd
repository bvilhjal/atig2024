...
##### A1: They are binary genotype files
...
##### A2: The kinship coefficient is defined as the probability that a pair of randomly sampled homologous alleles are identical by descent. This is different from genetic relatedness matrix.  Threshold used is thr.king = 2^-4.5

##### Q3: How many individuals were removed?
##### A3: (Sorry asked too early). length(unique(ind.rel)) gives 58

##### Q4: Can you plot the kinship values, also using a less stringent threshold?
##### A4: Rerun with less stringent threshol and plot hist(rel$KINSHIP)
...
##### A5: We removed 58 individuals


##### Q6: What other parameters does bed_autoSVD accept?
##### A6: (obj.bed, ind.row = ind.norel, k = 20, ncores = nb_cores()). k refers to the number of PCs
  obj.bed,
...
##### A8: The first PC. (>obj.svd$d gives the eigenvalues)

##### Q9: Can you describe what these PCs 3-8 are capturing?
##### A9: The first PC

##### Q10: Can you plot the 20 PCs?  
##### A10: plot_grid(plotlist = lapply(1:10, ...
...
##### A13: Generally it uses Online Augmentation, Decomposition, and Procrustes (OADP) (Zhang et al., Bioinformatics 2020)
...
##### A14: No, not really.  Only one individual was removed.
